...
running command...
$ corev2 (--version)
@oclif/plugin-test-core-v2/0.2.19 linux-x64 node-v22.22.3
$ corev2 --help [COMMAND]
USAGE
  $ corev2 COMMAND
...
...
_See code: [src/commands/core-v2.ts](https://github.com/oclif/plugin-test-core-v2/blob/0.2.19/src/commands/core-v2.ts)_
