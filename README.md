...
running command...
$ corev2 (--version)
@oclif/plugin-test-core-v2/0.2.17 linux-x64 node-v20.20.1
$ corev2 --help [COMMAND]
USAGE
  $ corev2 COMMAND
...
...
_See code: [src/commands/core-v2.ts](https://github.com/oclif/plugin-test-core-v2/blob/0.2.17/src/commands/core-v2.ts)_
